...
public class TVService implements RegisterListener, Runnable {
	...
	// Do the registration
	public TVService() throws DNSSDException, InterruptedException {

		// Load the description file
		InputStream in = TVService.class.getResourceAsStream("description.properties");
		p = new Properties();
		if (in != null) {
			try {
